...
<!-- where $T$ is the frame-time in seconds. So for a constant $125$ fps framerate and standard $\text{g\_speed}$ of $320$, then ![a=2.56](assets/strafing-theory/math-accel2.jpg) ups per frame. -->
